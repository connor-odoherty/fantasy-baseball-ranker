class CreateProjectionModels < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :batting_projections, [:player_id, :projection_system_id], unique: true, name: 'index_batting_projection_on_player_and_system'
    ...
    add_index :pitching_projections, [:player_id, :projection_system_id], unique: true, name: 'index_pitching_projection_on_player_and_system'
  end
end

...
ActiveRecord::Schema.define(version: 20_190_306_065_717) do
  ...
  create_table 'batting_projections', force: :cascade do |t|
    ...
    t.index %w[player_id projection_system_id], name: 'index_batting_projection_on_player_and_system', unique: true, using: :btree
  ...
  create_table 'pitching_projections', force: :cascade do |t|
    ...
    t.datetime 'created_at',                    null: false
    t.datetime 'updated_at',                    null: false
    t.index %w[player_id projection_system_id], name: 'index_pitching_projection_on_player_and_system', unique: true, using: :btree
  ...
  create_table 'pro_ranking_players', force: :cascade do |t|
    ...
    t.integer 'min_pick'
    t.integer 'max_pick'
    t.index %w[player_id pro_ranking_set_id], name: 'index_unique_on_player_and_pro_ranking_set', unique: true, using: :btree
  ...
  create_table 'season_batting_lines', force: :cascade do |t|
    ...
    t.index %w[player_id data_season_id], name: 'index_batting_line_on_player_and_season', unique: true, using: :btree
  ...
  create_table 'season_pitching_lines', force: :cascade do |t|
    ...
    t.index %w[player_id data_season_id], name: 'index_pitching_line_on_player_and_season', unique: true, using: :btree
  ...
  create_table 'user_players', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer  'tags'
    t.index %w[player_id user_id], name: 'index_user_players_on_player_id_and_user_id', unique: true, using: :btree
  ...
  create_table 'user_ranking_players', force: :cascade do |t|
    ...
    t.index %w[user_player_id user_ranking_set_id], name: 'index_unique_on_user_player_and_user_ranking_set', unique: true, using: :btree
